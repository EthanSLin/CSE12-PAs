 ...
 * File description: This is the MyLinkedList class file. It contains the 
 * framework for the MyLinkedList and Node classes
 */

/**This is the class MyLinkedList. It lists the methods,
...
public class MyLinkedList<E> implements MyReverseList<E>{
    ...
    public void reverseRegion(int fromIndex, int toIndex){
        ...
        if (fromIndex < toIndex) {
            E fromElement = getNth(fromIndex).data; 
            E toElement = getNth(toIndex).data;
            Node atNode = head.next;
            //Iterates through the list and swaps the elements of the objects 
            //at fromIndex and toIndex
            for (int i = 0; i < size; i++) {
                if (i == fromIndex) {
                    atNode.setElement(toElement);
                }
                else if (i == toIndex) {
                    atNode.setElement(fromElement);
                }
                atNode = atNode.next;
            }
        }
